...
def set_background_with_overlay(image_url):
    st.markdown(
        ...
        * {{
        ...
        /* Gaya untuk teks dalam inputan dan tombol */
        .streamlit-expanderHeader, .stTextInput, .stNumberInput, .stSelectbox {{
            color: black !important;
        }}
        .stButton button {{
            background-color: #4CAF50; /* Tombol dengan latar hijau */
            color: white !important;   /* Mengubah teks tombol menjadi putih */
            border: none;
            padding: 10px 20px;
            font-size: 16px;
            border-radius: 5px;
...
# ========================
    ...
    st.header("🥗 Makanan Sehat vs 🍔 Tidak Sehat")
    ...
    with col1:
        ...
        st.markdown("""
        - Sayuran segar (bayam, brokoli)
        - Buah segar (apel, pepaya)
        - Ikan laut, ayam tanpa kulit
        - Kacang-kacangan, oats, air putih
        """)
...
# ========================
    ...
    st.title("📊 Rekomendasi Gizi Berdasarkan Usia")
